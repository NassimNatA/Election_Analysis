...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        if county_names not in county_names_list:

            # 4b: Add the existing county to the list of counties.
            county_names_list.append(county_names)

            # 4c: Begin tracking the county's vote count.
            county_votes_dict[county_names] = 0

        # 5: Add a vote to that county's vote count.
        county_votes_dict[county_names] += 1
...
with open(file_to_save, "w") as txt_file:
    ...
    if (cvotes > winning_county_count):
            ...
            winning_percentage = c_v_percentage
